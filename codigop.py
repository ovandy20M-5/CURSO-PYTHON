...
CREATE TABLE IF NOT EXISTS `mydb`.`Function` (
  ...
  `Consultation of purchased tickets` INT NOT NULL,
  PRIMARY KEY (`id_Function`),
  INDEX `fk_Funcion_Consulta_De_Boletos_Comprados1_idx` (`Consultation of purchased tickets` ASC) VISIBLE,
  CONSTRAINT `fk_Funcion_Consulta_De_Boletos_Comprados1`
    FOREIGN KEY (`Consultation of purchased tickets`)
    REFERENCES `mydb`.`Consultation of purchased tickets` (`id_Consultation of purchased tickets`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Ticket Cancellation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Ticket Cancellation` (
  `id_Ticket Cancellation` INT NOT NULL,
  `Ticket Cancellation` VARCHAR(45) NOT NULL,
  `id_Function` INT NOT NULL,
  PRIMARY KEY (`id_Ticket Cancellation`),
  INDEX `fk_Cancelacion_De_Boletos_Funcion1_idx` (`id_Function` ASC) VISIBLE,
  CONSTRAINT `fk_Cancelacion_De_Boletos_Funcion1`
